...
# Thermal properties
  [./Thermal_conductivity_bentonite]
    ...
    Temp = T
    Pcap = Pcap
    dry_thermal_conductivity = '1.570E7'
    wet_thermal_conductivity = '3.677E7'
    dry_specific_heat = 894
    wet_specific_heat = 1337
    block = 'bentonite'
  [../]
  [./Thermal_conductivity_backfill]
    ...
    Temp = T
    Pcap = Pcap
    dry_thermal_conductivity = '1.536E7'
    wet_thermal_conductivity = '4.910E7'
  ...
  [./Material_properties_bentonite]
    ...
    prop_names = 'Van_genuchten_alpha Van_genuchten_lambda Iperm   porosity Medium_density Medium_specific_heat Klinkenberg_const'
    prop_values = '7.289E-7           0.2985               1.5E-20 0.41     1600           1000                1.0E9'
    block = 'bentonite'
  [../]
  [./Material_properties_backfill]
    type = GenericConstantMaterial
    prop_names = 'Van_genuchten_alpha Van_genuchten_lambda Iperm   porosity Medium_density Medium_specific_heat Klinkenberg_const'
    prop_values = '3.3E-7             0.5                  1.6E-19 0.4      1800           981                  1.0E8'
    block = 'backfill'
  [../]
  [./Material_properties_hostrock]
    type = GenericConstantMaterial
    prop_names = 'Van_genuchten_alpha Van_genuchten_lambda Iperm   porosity Medium_density Medium_specific_heat Klinkenberg_const'
    prop_values = '5E-7               0.6                  1.0E-18 0.01     2700           820                  6.86E5'
    block = 'hostrock'
  [../]
[]
...
#  nl_abs_tol = 1E-3
  ...
  scaling_group_variables = 'Pcap Pgas'
  [./TimeStepper]
