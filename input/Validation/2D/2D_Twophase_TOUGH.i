...
#    Water_viscosity = Water_viscosity
  ...
  [../]
  [./Vapor_advec_Pcap]
    type = TwoPhaseFlowVaporAdvectiveFluxTHMC
    variable = Pcap
    T = T
    Pgas = Pgas
    Water_density = Water_density 
  ...
  [../]
  [./Gas_Diffusion]
    type = TwoPhaseFlowVaporDiffusionTOUGH
    variable = Pcap
    Temp = T
    Pgas = Pgas
    porosity = porosity
...
# Gas Pressure
  ...
  [../]
  [./Air_advec_Pgas]
    type = TwoPhaseFlowAirAdvectiveFluxTHMC
    variable = Pgas
    T = T
    Pcap = Pcap
    Water_density = Water_density 
  ...
  [../]
  [./Air_Diffusion]
    type = TwoPhaseFlowAirDiffusionTOUGH
    variable = Pgas
    Temp = T
    Pcap = Pcap
    porosity = porosity
...
# Hydraulic properties
  [./Material_properties_bentonite]
    ...
    prop_values = '2.857E-8           0.3                  2E-21   0.41     1600           966                  1.0E9'
    block = 'bentonite'
  [../]
  [./Material_properties_hostrock]
    type = GenericConstantMaterial
    prop_names = 'Van_genuchten_alpha Van_genuchten_lambda Iperm   porosity Medium_density Medium_specific_heat Klinkenberg_const'
    prop_values = '6.803E-7           0.6                  1.0E-17 0.01     2700           900                  6.86E5'
    block = 'hostrock'
  [../]
[]
