 ...
 */
class ThermalPropertyRichards : public Material
{
public:
  static InputParameters validParams();

  ThermalPropertyRichards(const InputParameters & parameters);
...
private:
  ...
  MaterialProperty<Real> & _Wspecific_heat;
