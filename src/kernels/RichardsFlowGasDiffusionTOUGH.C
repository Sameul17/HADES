...
#include "RichardsFlowGasDiffusionTOUGH.h"

registerMooseObject("HadesApp", RichardsFlowGasDiffusionTOUGH);

InputParameters
RichardsFlowGasDiffusionTOUGH::validParams()
{
...
RichardsFlowGasDiffusionTOUGH::RichardsFlowGasDiffusionTOUGH(const InputParameters & parameters)
  : Kernel(parameters),
...
Real
RichardsFlowGasDiffusionTOUGH::computeQpResidual()
{
  ...
  Real D_v = 2.15E-7 * pow(_T[_qp] / 273.15 , 1.8) * 365 * 24 *3600;
...
Real
RichardsFlowGasDiffusionTOUGH::computeQpJacobian()
{
  Real R = 8.314; // Gas cosntant [J/(molK)]
  Real Mw = 0.01801528; // Molar mass of water [kg/mol]
  Real Rv = 461.5; // The specific gas constant [J/(kgK)]
...
Real
RichardsFlowGasDiffusionTOUGH::computeQpOffDiagJacobian(unsigned int jvar)
{
  Real R = 8.314; // Gas cosntant [J/(molK)]
  Real Mw = 0.01801528; // Molar mass of water [kg/mol]
  Real Rv = 461.5; // The specific gas constant [J/(kgK)]
