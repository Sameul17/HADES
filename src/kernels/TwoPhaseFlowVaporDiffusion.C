...
#include "TwoPhaseFlowVaporDiffusion.h"

registerMooseObject("HadesApp", TwoPhaseFlowVaporDiffusion);

InputParameters
TwoPhaseFlowVaporDiffusion::validParams()
{
...
TwoPhaseFlowVaporDiffusion::TwoPhaseFlowVaporDiffusion(const InputParameters & parameters)
  : Kernel(parameters),
...
Real
TwoPhaseFlowVaporDiffusion::computeQpResidual()
{
...
Real
TwoPhaseFlowVaporDiffusion::computeQpJacobian()
{
  Real R = 8.314; // Gas cosntant [J/(molK)]
  Real Mw = 0.01801528; // Molar mass of water [kg/mol]
  Real Rv = 461.5; // The specific gas constant [J/(kgK)]
...
Real
TwoPhaseFlowVaporDiffusion::computeQpOffDiagJacobian(unsigned int jvar)
{
  Real R = 8.314; // Gas cosntant [J/(molK)]
  Real Mw = 0.01801528; // Molar mass of water [kg/mol]
  Real Rv = 461.5; // The specific gas constant [J/(kgK)]
